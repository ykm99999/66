...
cp build/mt7981/release/bl2.bin $OUTPUT_DIR/atf/bl2-1g-nor.bin 2>/dev/null || echo "No bl2.bin"
cp build/mt7981/release/bl2.elf $OUTPUT_DIR/atf/bl2-1g-nor.elf 2>/dev/null || echo "No bl2.elf"
...
cp build/mt7981/release/bl2.bin $OUTPUT_DIR/atf/bl2-ram-1g.bin 2>/dev/null || echo "No bl2.bin"
cp build/mt7981/release/bl2.elf $OUTPUT_DIR/atf/bl2-ram-1g.elf 2>/dev/null || echo "No bl2.elf"
...
# 将 fiptool 复制到 U-Boot 源码目录（避免 U-Boot 编译时找不到）
