...
# ========== 准备 ImmortalWrt 源码 ==========
cd $WORKSPACE
rm -rf immortalwrt-build-2512
cp -r $SOURCE_DIR/immortalwrt immortalwrt-build-2512
cd immortalwrt-build-2512
...
# 保存当前构建目录路径，供 part4 使用
echo $PWD > $WORKSPACE/build-dir-2512.txt
